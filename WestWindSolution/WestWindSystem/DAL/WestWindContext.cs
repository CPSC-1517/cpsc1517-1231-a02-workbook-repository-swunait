...
internal partial class WestWindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07CD01C76E");
        ...
        {
            entity.HasKey(e => e.ManifestItemId).HasName("PK__Manifest__9000192CCC6E8273");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__5CAD378DDD9CF09C");
